...
<style>
  ...
  #rsw-1 .bar-col .fill{ width:78%; background:#555; border-radius:2px 2px 0 0; align-self:flex-end; }
  ...
  [data-bs-theme="dark"] #rsw-1 .bar-col .fill{ background:#999; }
...
(function(){
  ...
  var d = [1,1,1,1];             // deaths by day of death (daily incidence, one per day).
                                  ...
                                  // It reproduces the source's D3=4, b3=4/19=0.21, p3=0.28.
