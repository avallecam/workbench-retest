...
```{r renewal-widget, echo=FALSE, results='asis'}
cat(readLines("files/renewal-slidestyle-widget.html", warn = FALSE), sep = "\n")
```

Here's another one, for a different worked example:

```{r cfr-widget, echo=FALSE, results='asis'}
cat(readLines("files/cfr-slidestyle-widget.html", warn = FALSE), sep = "\n")
```
